...
export default function AdminPartnersCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (fd: FormData) => contentService.createPartner(fd),
    onSuccess: () => {
      toast.success('สร้างพาร์ทเนอร์สำเร็จ')
    ...
    <div style={{ fontFamily: F, maxWidth: 640, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 700, color: '#111827', fontFamily: F, margin: 0 }}>สร้างพาร์ทเนอร์</h1>
        </div>
      ...
      <div style={{ backgroundColor: '#fff', borderRadius: 12, border: '1px solid #e5e7eb', padding: '30px', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ marginBottom: 28, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div
            ...
            style={{ width: 200, height: 200, borderRadius: 12, backgroundColor: '#ede9fe', border: '2px dashed #c4b5fd', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', overflow: 'hidden' }}
          >
            {preview
              ...
              : (
                <div style={{ textAlign: 'center', color: '#7c3aed' }}>
                  ...
                  <div style={{ fontSize: 15, fontFamily: F }}>คลิกเพื่ออัปโหลดโลโก้</div>
                </div>
              )
            }
          </div>
